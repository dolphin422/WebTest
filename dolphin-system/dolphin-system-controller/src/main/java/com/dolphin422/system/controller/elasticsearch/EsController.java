...
public class EsController {
    ...
    public String addData() {
        ...
        testVo.setId("201904111943AA");
        testVo.setTitle("测试Title");
        testVo.setValue("2018");
        testVo.setDate(new Date());
        String id = ElasticsearchUtil.addData(indexName, esType, testVo.getId(), testVo);
    ...
    public String aggregation() {
        try {
            ...
            Response response = ElasticsearchUtil
                .getLowLevelClient()
                .performRequest("POST", endPoint, Collections.<String, String>emptyMap(), entity);
            return EntityUtils.toString(response.getEntity());
        } catch (IOException e) {
